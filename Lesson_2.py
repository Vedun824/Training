...
# Данный пример показывает создание переменной 'spaces' и присвоение её значения в 25 пробелов и использованием этой переменной для смещения первых 3 строк вправо
